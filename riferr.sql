...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2019 at 02:21 PM
...
INSERT INTO `users` (`user_id`, `user_email`, `user_password`, `user_name`, `user_phone`, `user_address`, `user_role`) VALUES
(1, 'admin@admin.com', 'admin', 'admin fiverr', '098000', 'jalan-in aja', 0),
(2, 'seller1@seller1.com', 'seller1', 'seller1 coy', '0980009', 'jalan-in aja1', 1),
(3, 'seller2@seller2.com', 'seller2', 'seller 2 coy', '098098', 'jalan-in aja 2', 1),
(4, 'buyer1@buyer.com', 'buyer1', 'buyer 1 boy', '098098', 'jalan-in aza 1', 2),
(5, 'buyer2@buyer.com', 'buyer2', 'buyer 2 boy', '0980900', 'jalan-in aza 2', 2);
